...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.coordinates.setGeometry(QtCore.QRect(140, 660, 67, 17))
        self.coordinates.setObjectName("coordinates")
        self.graphicsView = QtWidgets.QGraphicsView(self.centralwidget)
        self.graphicsView.setGeometry(QtCore.QRect(140, 120, 1031, 531))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.coordinates.setText(_translate("MainWindow", "TextLabel"))
